...
function Home() {
  return (
    <div className="min-h-screen bg-[#F2F1EE] text-[#4b3f2f] flex flex-col font-sans">
      ...
      <header className="flex justify-between items-center px-6 py-4 backdrop-blur-md bg-white/30 shadow-lg z-10 border-b border-[#d2b48c]">
        <h1 className="text-3xl font-semibold tracking-wide text-[#96694B] drop-shadow-sm">
          📚 BookVerse
        </h1>
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-6 py-10">
        ...
        <Link
          to="/login"
          className="px-8 py-3 bg-[#8B4513] text-[#F2F1EE] font-bold rounded-full hover:scale-105 hover:brightness-110 transition-transform duration-300"
        >
          Start Exploring
        </Link>
      </div>
      ...
      {/* Categories */}
      <section className="bg-[#F2F1EE] text-[#4b3f2f] py-16 px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {[
            ...
            <div
              key={index}
              className="bg-transparent border border-[#8B4513] rounded-xl p-6 shadow-lg text-center hover:scale-105 transition-transform duration-300"
            >

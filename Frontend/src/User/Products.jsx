...
function Products() {
  ...
  return (
    <div className="min-h-screen bg-[#fdfaf3] text-[#4b3e2e] font-serif">
      <Unavbar />
      <div className="container mx-auto p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
          {items.map((item) => (
            <div
              key={item._id}
              className="bg-[#fdfaf3] border border-[#8B4513] w-64 rounded-lg shadow hover:shadow-md transition duration-300 p-2"
            >
              <img

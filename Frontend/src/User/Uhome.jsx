...
const Uhome = () => {
  ...
  return (
    <div className="bg-[#F2F1EE] min-h-screen text-[#4b3e2e] font-serif">
      <Unavbar />
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {bestsellerBooks.map((book, index) => (
            <Link
              key={index}
              to="/uproducts"
              className="w-60 bg-[#fdfaf3] rounded border border-[#8B4513] shadow hover:shadow-md transition duration-300 p-2"
            >
              <img
                src={book.img}
                alt={book.title}
